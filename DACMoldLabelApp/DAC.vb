...
Public Class DAC
    ...
    Public Shared Sub ExecuteSP(ByVal storedprocedure As String, _
    ByVal cn As SqlConnection, ByVal ParamArray arrParam() As SqlParameter)
    ...
    Public Shared Function ExecuteSP_ReturnObj(ByVal storedprocedure As String, _
