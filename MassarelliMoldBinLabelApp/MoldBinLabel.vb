...
Public Class MoldBinLabel
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MassarelliMoldLabelApp.MoldBinLabel.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMoldBinLabel
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MoldBinLabel = New MoldBinLabel()
        rpt.Site = Me.Site
        Return rpt
    End Function
